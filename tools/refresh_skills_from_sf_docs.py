#!/usr/bin/env python3
"""
Refresh selected Data360 Beast skills using only the local sf-docs Help export.
...
- Rewrites only sections delimited by SF_DOC_SYNC markers in a small set of SKILL.md files
...
def build_skill_updates() -> dict[Path, dict[str, str]]:
    ...
    add("skills/data360beast/SKILL.md", "weekly-watch-gate", render_changelog_gate(s_changelog))
    add(
